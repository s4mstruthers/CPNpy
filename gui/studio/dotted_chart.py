...
from .widgets import Card, ElidedLabel, button, hbox, label, scroll, vbox
...
class DottedChartPanel(QWidget):
    ...
    def __init__(self, document: LogDocument, parent=None) -> None:
        ...
        hint = label("Drag to zoom into an area · ⌘-scroll or pinch to zoom · Alt-drag to pan · "
    ...
    def _build_settings(self) -> QWidget:
        ...
        self.grid_step.setRange(0.0, 1e9)
